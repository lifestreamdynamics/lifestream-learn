...
Reference infrastructure for running Lifestream Learn — suitable for self-hosters and as a blueprint for the production VPS. The hosted service at `learn.REDACTED-BRAND-DOMAIN` uses the Ansible playbooks here with production-specific overrides kept in the private `ops/` repo.
