...
Lifestream Learn is planned as a commercial SaaS at `learn.lifestreamdynamics.com`. The question: should the code be open source, and if so under which license?
