...
```bash
# Public
curl -sfI https://learn-api.REDACTED-BRAND-DOMAIN/health
curl -sfI https://learn.REDACTED-BRAND-DOMAIN/

# On-host (requires SSH)
ssh root@REDACTED-VPS-HOST 'curl -sf http://127.0.0.1:3101/health'
ssh root@REDACTED-VPS-HOST 'pm2 status learn-api learn-transcode-worker'
