...
/// @nodoc
mixin _$DesignerApplicationWithApplicant {
  DesignerApplication get application => throw _privateConstructorUsedError;
  String? get applicantEmail => throw _privateConstructorUsedError;
  String? get applicantDisplayName => throw _privateConstructorUsedError;

  /// Create a copy of DesignerApplicationWithApplicant
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $DesignerApplicationWithApplicantCopyWith<DesignerApplicationWithApplicant>
  get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DesignerApplicationWithApplicantCopyWith<$Res> {
  factory $DesignerApplicationWithApplicantCopyWith(
    DesignerApplicationWithApplicant value,
    $Res Function(DesignerApplicationWithApplicant) then,
  ) =
      _$DesignerApplicationWithApplicantCopyWithImpl<
        $Res,
        DesignerApplicationWithApplicant
      >;
  @useResult
  $Res call({
  ...
  $DesignerApplicationCopyWith<$Res> get application;
}

/// @nodoc
class _$DesignerApplicationWithApplicantCopyWithImpl<
  $Res,
  $Val extends DesignerApplicationWithApplicant
>
    implements $DesignerApplicationWithApplicantCopyWith<$Res> {
  _$DesignerApplicationWithApplicantCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    Object? applicantDisplayName = freezed,
  }) {
    return _then(
      _value.copyWith(
            ...
            applicantEmail: freezed == applicantEmail
                ...
                : applicantEmail // ignore: cast_nullable_to_non_nullable
                      as String?,
            applicantDisplayName: freezed == applicantDisplayName
                ? _value.applicantDisplayName
                : applicantDisplayName // ignore: cast_nullable_to_non_nullable
                      as String?,
          )
          as $Val,
    );
  ...
  @pragma('vm:prefer-inline')
  $DesignerApplicationCopyWith<$Res> get application {
    return $DesignerApplicationCopyWith<$Res>(_value.application, (value) {
...
/// @nodoc
abstract class _$$DesignerApplicationWithApplicantImplCopyWith<$Res>
    implements $DesignerApplicationWithApplicantCopyWith<$Res> {
  factory _$$DesignerApplicationWithApplicantImplCopyWith(
    _$DesignerApplicationWithApplicantImpl value,
    $Res Function(_$DesignerApplicationWithApplicantImpl) then,
  ) = __$$DesignerApplicationWithApplicantImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({
    DesignerApplication application,
...
/// @nodoc
class __$$DesignerApplicationWithApplicantImplCopyWithImpl<$Res>
    extends
        _$DesignerApplicationWithApplicantCopyWithImpl<
          $Res,
          _$DesignerApplicationWithApplicantImpl
        >
    implements _$$DesignerApplicationWithApplicantImplCopyWith<$Res> {
  __$$DesignerApplicationWithApplicantImplCopyWithImpl(
    _$DesignerApplicationWithApplicantImpl _value,
    $Res Function(_$DesignerApplicationWithApplicantImpl) _then,
  ) : super(_value, _then);
...
class _$DesignerApplicationWithApplicantImpl
    implements _DesignerApplicationWithApplicant {
  const _$DesignerApplicationWithApplicantImpl({
  ...
  @override
  String toString() {
    return 'DesignerApplicationWithApplicant(application: $application, applicantEmail: $applicantEmail, applicantDisplayName: $applicantDisplayName)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DesignerApplicationWithApplicantImpl &&
            (identical(other.application, application) ||
                other.application == application) &&
            (identical(other.applicantEmail, applicantEmail) ||
                other.applicantEmail == applicantEmail) &&
            (identical(other.applicantDisplayName, applicantDisplayName) ||
                other.applicantDisplayName == applicantDisplayName));
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DesignerApplicationWithApplicantImplCopyWith<
    _$DesignerApplicationWithApplicantImpl
  >
  get copyWith =>
      __$$DesignerApplicationWithApplicantImplCopyWithImpl<
...
abstract class _DesignerApplicationWithApplicant
    implements DesignerApplicationWithApplicant {
  const factory _DesignerApplicationWithApplicant({
    required final DesignerApplication application,
    final String? applicantEmail,
    final String? applicantDisplayName,
  }) = _$DesignerApplicationWithApplicantImpl;

  @override
  DesignerApplication get application;
  @override
