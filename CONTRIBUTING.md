...
- **License:** by opening a PR you agree your contribution is licensed under AGPL-3.0. If you need a different license for your use case, email `eric@digitalartifacts.ca` before contributing.
